...
import { Users, Briefcase, TrendingUp, CheckCircle, BarChart3, Rocket } from 'lucide-react';
...
const FunnelBar = ({ label, value, max, color }) => (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <div style={{ width: 130, fontSize: 12, color: '#8892a4', fontWeight: 600, flexShrink: 0 }}>{label}</div>
        <div style={{ flex: 1, height: 8, borderRadius: 4, background: 'rgba(255,255,255,0.06)' }}>
            <div style={{ height: '100%', borderRadius: 4, background: color, width: max > 0 ? `${(value / max) * 100}%` : '0%', transition: 'width 0.6s ease-out' }} />
        </div>
