                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center justify-between pt-6 border-t border-gray-800">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-bold text-gray-400 uppercase">{(typeof form.form_json === 'string' ? JSON.parse(form.form_json) : form.form_json)?.fields?.length ?? 0} Questions</span>
                                    </div>
